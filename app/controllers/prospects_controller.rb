class ProspectsController < ApplicationController
  attr_accessor :siren, :siret, :type, :denomination, :sigle, :nom_commercial, :enseigne, :adresse1, :adresse2, :adresse3, :adresse4, :code_postal, :commune, :ape_etablissement, :libelle_ape, :ape_entreprise, :immat_etablissement, :immat_entreprise, :forme_juridique, :fonction_dirigeant, :civilite_dirigeant, :prenom_dirigeant, :nom_dirigeant, :nom_representant_dirigeant, :type_dirigeant,
